...
},{"../js/inventoryController":2}],2:[function(require,module,exports){
...
const addItem = async (itemName, quantity) => {
  ...
  const result = await fetch(`${API_ADDR}/inventory/?itemName=${itemName}`, {
    method: "POST",
...
},{"./js/domController":1,"./js/inventoryController":2,"isomorphic-fetch":4}],4:[function(require,module,exports){
